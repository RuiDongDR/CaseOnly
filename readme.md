...
* The case-only design is a powerful approach to detect interactions but should be used with caution.* Rui Dong, Gao T. Wang, Andrew T. DeWan, Suzanne M. Leal. (submitted)
